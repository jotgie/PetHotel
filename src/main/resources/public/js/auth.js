...
//todo add an action to login which will contain a "with credentials resource flag"
...
app.factory('AuthService', function ($rootScope, $translate, Login, Session, PersistService, USER_ROLES, AUTH_EVENTS, notifyService) {
    ...
    authService.login = function (credentials) {
        var login = new Login(credentials);

        login.$save(login, function (response) {
